...
$main_menus = [
  ...
  'lms' => [
    'text' => __('LMS'),
    'url' => 'https://lms.smpsransa.sch.id'
  ],
  'news' => [
    'text' => __('Ebook'),
    'url' => 'https://ebook.smp1srandakan.lib.web.id/'
  ],  'libinfo' => [
    'text' => __('Information'),
  ...
  'help' => [
    'text' => __('Masukan'),
    'url' => 'https://portal.smpsransa.sch.id/masukan'
  ]
];
?>

<nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
  <a class="navbar-brand inline-flex items-center" href="https://perpus.smpsransa.sch.id">
    <?php
    ...
    ?>
      <svg class="fill-current text-white inline-block h-8 w-8" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 118.4 135" style="enable-background:new 0 0 118.4 135;" xml:space="preserve">
...
HTML;
      ...
      <?php } else { ?>
        <li class="nav-item mr-2 <?= $menu_member_active; ?>">
          <a class="btn btn-primary" href="index.php?p=visitor">Pengunjung</a>
        </li>
        <li class="nav-item mr-2 <?= $menu_member_active; ?>">
          <a class="btn btn-success" href="index.php?p=member"><?= __('Member Area') ?></a>
        </li>
        <li class="nav-item <?= $menu_member_active; ?>">
          <a class="btn btn-warning" href="index.php?p=login">Dashboard Admin</a>
        </li>
      <?php } ?>
